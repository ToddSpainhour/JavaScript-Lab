...
const printerError = (input) => {
  ...
  const errorLettersRegEx = /[n-z]/g
  let numberOfErrors = input.match(errorLettersRegEx)
  
  const output = (numberOfErrors === null) ? `0/${inputLength}` : `${numberOfErrors.length}/${inputLength}`
